...
# Load model
cnn_model = tf.keras.models.load_model(STATIC_FOLDER + "/models/" + "tubes_model_dauns.h5")
...
def classify(model,image):
    ...
    # resize_img = skimage.transform.resize(new_image, (100,100,3))
    ...
    class_names = ['Belimbing Wuluh', 'Sirih', 'Jeruk Nipis', 'Kemangi', 'Pandan', 'Nangka', 'Lidah Buaya', 'Pepaya', 'Seledri', 'Jambu Biji']
